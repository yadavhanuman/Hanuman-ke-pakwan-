...
session_start();
  ...
  if (isset($_SESSION['profile'])) {
      ...
      echo '<button class="profile">' . $_SESSION['profile'] . '</button>';
  }
  ?>
   ...
   font-weight:bolder;
    ...
    <body>
      ...
      <div class="container">
       ...
       <span class="span">+91 9696454876</span>
      ...
      <span class="span">hanumankepakvan@gmail.com</span>
      ...
      <nav class="navbar navbar-expand-lg navbar-dark fixed-top">
        ...
        NAV LIST--- -->
            <ul class="nav-li">
                ...
                <li class="navbar-item">
                    <a href="chefs.html" class="navbar-link hover-underline active">
     ...
     <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner">
        ...
        <div class="carousel-item">
          <img class="d-block w-0" src="images/c.jpg" alt="Third slide" style="width: 100%; height: 47rem;">
          <div class="carousel-caption d-none d-md-block">
           
          <div class="tophead">
              <!-- <h6>DRINKS MADE TO DELIGHT</h6> -->
              <h1 class="text-light text-dark">Enjoy Every Sip With Hanuman Ke Pakwan</h1>
              <p class="text-dark" style="font-weight:bolder;">A Celebration in Every Glass, Toast to Memorable Moments with our Specialty Drinks</p>
              <button class="viewmenu"><a href="Menu.html">VIEW OUR MENU</a></button>
              </div>
          </div>
        </div>
      ...
      <div class="OurStory">
          ...
          <div class="image-container">
            <div class="image-item">
              <img src="images/story1.jpg" alt="Image 1" height="180" width="200">
              <div class="image-overlay">
                <span></span>
              </div>
            </div>
            <div class="image-item">
              <img src="images/story2.png" alt="Image 2" height="200" width="200">
              <div class="image-overlay">
                <span></span>
              </div>
            </div>
            <div class="image-item">
              <img src="images/story3.jpg" alt="Image 2" height="240" width="210">
              <div class="image-overlay">
                <span></span>
              </div>
            </div>
  ...
  <div id="drink-slide">
    ...
    <!-- ----
      ...
      <div class="chef-container">
        <div class="chef-card">
          <img src="chefs/hanu.jpg" alt="Chef 1">
        ...
        <div class="chef-card">
          <img src="chefs/ashish.jpg" alt="Chef 2">
          <div class="bio-overlay">
            <p>Chef 2</p>
            <div class="description">
              <p>ashish Gupta</p>
        ...
        <div class="chef-card">
          <img src="chefs/sak.jpg" alt="Chef 2">
          <div class="bio-overlay">
            <p>Chef 3</p>
            <div class="description">
              <p>Saksham Katiyar</p>
        ...
        <div class="chef-card">
          <img src="chefs/atul.jpg" alt="Chef 2">
          <div class="bio-overlay">
            <p>Chef 4</p>
            <div class="description">
              <p>Atul Srivastava</p>
        ...
        <div class="chef-card">
          <img src="chefs/piyush.jpg" alt="Chef 2">
          <div class="bio-overlay">
            <p>Chef 5</p>
            <div class="description">
              <p>Piyush Bharadwaj</p>
              <p></p>
            </div>
          </div>
        </div>
      ...
      <footer>
          <div class="footer-content">
            ...
            <div class="footer-section">
              <h3>Contact Us</h3>
              <p>Email: hanumankepakwan91@gmail.com</p>
              <p>Phone: +91 9645487472</p>
              <p>Address: NSTI Allahabad New Katara 201002</p>
            </div>
            <div class="footer-section">
              <h3>Follow Us</h3>
